...
- **plutovg** [📁](./plutovg) [🌐](https://github.com/GerHobbelt/plutovg) -- PlutoVG is a standalone 2D vector graphics library in C, featuring Path Filling, Stroking and Dashing, Solid/Gradient/Texture Paints, Fonts support and Texts placement, Clipping, Compositing and various other Transformations.
